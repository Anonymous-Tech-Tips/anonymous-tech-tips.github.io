 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(u,e,n))},error:t[o+1],complete:t[o+2]};else{const n=fi(e,Xl);u=fi(n.firestore,id),h=n._query;const r=new sf(u);c={next:e=>{t[o]&&t[o](new nf(u,r,n,e))},error:t[o+1],complete:t[o+2]},Vd(e._query)}return function(e,t,n,r){const s=new xl(r),i=new rl(t,s,n);return e.asyncQueue.enqueueAndForget(async()=>Xh(await ql(e),i)),()=>{s.Nu(),e.asyncQueue.enqueueAndForget(async()=>Jh(await ql(e),i))}}(ad(u),h,a,c)}function hf(e,t){return function(e,t){const n=new Fs;return e.asyncQueue.enqueueAndForget(async()=>gl(await function(e){return Bl(e).then(e=>e.syncEngine)}(e),t,n)),n.promise}(ad(e),t)}class lf{constructor(e,t){this._firestore=e,this._commitHandler=t,this._mutations=[],this._committed=!1,this._dataReader=wd(e)}set(e,t,n){this._verifyNotCommitted();const r=df(e,this._firestore),s=Yd(r.converter,t,n),i=_d(this._dataReader,"WriteBatch.set",r._key,s,null!==r.converter,n);return this._mutations.push(i.toMutation(r._key,$a.none())),this}update(e,t,n,...r){this._verifyNotCommitted();const s=df(e,this._firestore);let i;return i="string"==typeof(t=N(t))||t instanceof ud?bd(this._dataReader,"WriteBatch.update",s._key,t,n,r):Id(this._dataReader,"WriteBatch.update",s._key,t),this._mutations.push(i.toMutation(s._key,$a.exists(!0))),this}delete(e){this._verifyNotCommitted();const t=df(e,this._firestore);return this._mutations=this._mutations.concat(new rc(t._key,$a.none())),this}commit(){return this._verifyNotCommitted(),this._committed=!0,this._mutations.length>0?this._commitHandler(this._mutations):Promise.resolve()}_verifyNotCommitted(){if(this._committed)throw new Us(Vs.FAILED_PRECONDITION,"A write batch can no longer be used after commit() has been called.")}}function df(e,t){if((e=N(e)).firestore!==t)throw new Us(Vs.INVALID_ARGUMENT,"Provided document reference is from a different Firestore instance.");return e}function ff(){return new Td("serverTimestamp")}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function pf(e){return ad(e=fi(e,id)),new lf(e,t=>hf(e,t))}!function(e,t=!0){Cs=$e,Fe(new R("firestore",(e,{instanceIdentifier:n,options:r})=>{const s=e.getProvider("app").getImmediate(),i=new id(new zs(e.getProvider("auth-internal")),new Ks(s,e.getProvider("app-check-internal")),function(e,t){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new Us(Vs.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new no(e.options.projectId,t)}(s,n),s);return r={useFetchStreams:t,...r},i._setSettings(r),i},"PUBLIC").setMultipleInstances(!0)),Ke(Is,bs,e),Ke(Is,bs,"esm2020")}();export{vi as T,od as a,Jn as b,ir as c,Qn as d,Hd as e,Zl as f,us as g,uf as h,He as i,cf as j,ff as k,Kd as l,ed as m,of as n,Yn as o,pf as p,jd as q,Xn as r,Zn as s,af as u,qd as w};
